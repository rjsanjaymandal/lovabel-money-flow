  ...
  return (
    <>
      <Sheet open={open} onOpenChange={setOpen}>
        ...
        <SheetContent
          side="bottom"
          className="pb-safe rounded-t-none sm:rounded-t-[2rem] border-t-0 shadow-[0_-10px_40px_rgba(0,0,0,0.2)] bg-background/95 backdrop-blur-xl h-[100dvh] sm:h-[85vh] flex flex-col"
        >
            ...
            <div className="pt-2 px-1 mt-auto">
              ...
              <div className="grid gap-3">
                ...
                >
                  ...
                  <div className="text-left">
                    <div className="leading-none mb-1 text-rose-400 group-hover:text-rose-300 transition-colors">
                      Sign Out
                    </div>
                    <div className="text-xs text-rose-500/50 font-normal">
                      Log out of account
                    </div>
                  </div>
                </Button>
