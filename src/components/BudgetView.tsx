          ...
          <div className="flex flex-col items-center justify-center py-2 sm:py-4">
            <div className="relative w-64 h-64 flex items-center justify-center">
              ...
              <div
                className={`absolute inset-0 rounded-full bg-gradient-to-tr ${
                  percentage > 100
                    ...
                    : "from-emerald-300/20 to-blue-500/20"
              ...
              <div className="relative z-10 text-center">
                ...
                <p className="text-white/80 text-sm font-medium mt-2 uppercase tracking-widest">
                  Used
                </p>
              </div>
              ...
              {/* Ring */}
              <svg
                className="absolute inset-0 w-full h-full -rotate-90 text-white/10"
                viewBox="0 0 100 100"
              >
                <circle
                  cx="50"
                ...
                <circle
                  ...
                  strokeDasharray="283"
                  strokeDashoffset={
                    283 - (283 * Math.min(percentage, 100)) / 100
                  }
            ...
            <div className="grid grid-cols-2 gap-4 sm:gap-6 w-full mt-8">
              <div className="text-center p-4 rounded-2xl bg-white/10 backdrop-blur-md border border-white/10 hover:bg-white/15 transition-colors">
                <p className="text-xs sm:text-sm text-white/60 mb-1 uppercase tracking-wide font-medium">
                  Spent
                </p>
        ...
        {budgets.length === 0 ? (
          <div className="col-span-full flex flex-col items-center justify-center py-16 px-4 bg-muted/30 rounded-3xl border border-dashed border-muted-foreground/25 animate-fade-in">
            ...
            <p className="text-muted-foreground text-center max-w-sm mb-6">
              Take control of your finances by setting monthly limits for
