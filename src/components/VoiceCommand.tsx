...
// Reuse Speech Recognition interfaces to avoid 'any'
          ...
          <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/80 backdrop-blur-xl">
            ...
            >
              ...
              >
                {/* Core */}
                <div
                  className={`w-32 h-32 rounded-full bg-gradient-to-tr from-indigo-500 via-purple-500 to-pink-500 blur-md flex items-center justify-center transition-all duration-300 ${
                    isListening
                      ? "scale-110 shadow-[0_0_100px_rgba(168,85,247,0.5)]"
